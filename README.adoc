...
This is a simple shim for the `sudo` command that utilizes https://www.mankier.com/1/doas[doas].
...
It's written in ~120 lines of POSIX shell.


== Requirements

* http://pubs.opengroup.org/onlinepubs/9699919799/utilities/V3_chap02.html[POSIX-sh] compatible shell (e.g. Busybox ash, dash, ZSH, bash, …)
* `awk`, `cat` (BSD, Busybox or GNU)
